...
void main() async {
  ...
  String fileString = await File("lib/dictionnary.json").readAsString();
  ...
  for(int i = start; i <= end; i++){
    ...
    try{
      Word current = await getWord("https://www.larousse.fr/dictionnaires/francais/mot/$i");
...
Future<Word> getWord(String url) async{
...
Word parseList(List<String> lines, String word){
  // print("lines = $lines");
  ...
  return Word(word: word, definitions: definitions, synonymous: synonymous, opposites: opposites);
}
